...
faq_data = {
    "fee structure": "The tuition fee for undergraduate program is around ₹10,000 per year along with the admission fee of ₹5,000 in the first year and the special fee of ₹300 every year. For postgraduate programs, it varies based on the course. For M.Tech the tuition fee is around ₹50,000 per year and for MCA the tuition fee is around ₹27,000 per year",
    "location": "JNTU-GV University College of Engineering is located in Nh 43, Dwarapudi(Post)-535003, Vizianagaram, Andhra Pradesh, India.",
    ...
    "admission process": "Admission to regular B.Tech Programmes are made based on the rank secured in Engineering, Agriculture & Medicine Common Entrance Test(EAMCET) conducted by Andhra Pradesh State Council of Higher Education (APSCHE). Admission to regular M.tech Programme is based on GATE or PGCET ranking conducted by Andhra Pradesh State Council of Higher Education(APSCHE).",
    ...
    "sports": "JNTU-GV provides sports facilities for all the students and staff of this institute. It has excellent infrastructure facilities for both outdoor and indoor games. The outdoor games include cricket, football, basketball, Badminton, Ball Badminton, Kabaddi, Kho-kho, Hand Ball, Hockey, TenniCoit, Thowball and Tennis. Volley Ball , Flood light facility is provided to all the outdoor games. The indoor games include Chess, Caroms, Gymnastics, Badminton, Table Tennis, Weight Lifting and 16 & 12 stations multi-Gyms. It encourages students to participate in sports events and maintains facilities to support a range of athletic activities."
}
...
def chatbot_interface():
    ...
    conversation_area.configure(bg="white", fg="black")
    ...
    def update_conversation(user_input, bot_response):
        ...
        conversation_area.tag_config("bot_text", foreground="black")
